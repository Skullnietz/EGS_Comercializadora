	             		...
	             		======================================-->      
	             	 	...
	             	 	<div id="collapse'.$value["id"].'" class="panel-collapse collapse collapseSlide">
                						...
                						<!--=====================================
                      					...
                      					<div class="form-group">
                        					...
                        					<p class="help-block">
                        						...
                        						<img loading="lazy" src="'.$value["imgFondo"].'" class="img-thumbnail previsualizarFondo" width="200px">
                      					...
                      					<div class="form-group">
                        					...
                        					<input type="text" class="form-control urlSlide" indice="'.$key.'" value="'.$value["url"].'" placeholder="EJEMPLO: /memoria-usb-64-gb-kingdton">
				                ...
				                <div class="col-md-4 col-xs-12">
				                    ...
				                    <div class="box-body">
				                      ...
				                      <div class="form-group">
				                        ...
				                        <p class="help-block">
				                          <img loading="lazy" src="'.$value["imgProducto"].'" class="img-thumbnail previsualizarProducto" width="200px">
				                        </p>
				                      ...
				                      <div class="form-group">
					                    ...
					                    ======================================--> 
					                      ...
					                      <div class="form-group">
					                        ...
					                        echo '<input type="text" indice="'.$key.'" value="" class="slider
					                          form-control posHorizontalTexto posHorizontalTexto'.$key.'" 
					                          tipoSlide = "'.$value["tipoSlide"] .'"
					                          data-slider-min="0" 
					                          data-slider-max="50"
					                          data-slider-step="5"
							...
							<div class="slide">
									...
									<img loading="lazy" class="cambiarFondo" src="'.$servidor.$value["imgFondo"].'">

									<div class="slideOpciones '.$value["tipoSlide"].'">
										
										<img loading="lazy" class="imgProducto" src="'.$servidor.$value["imgProducto"].'" style="top:'.$estiloImgProducto["top"].'%; right:'.$estiloImgProducto["right"].'%; width:'.$estiloImgProducto["width"].'%; left:'.$estiloImgProducto["left"].'%">
										...
										<div class="textosSlide" style="top:'.$estiloTextoSlide["top"].'%; left:'.$estiloTextoSlide["left"].'%; width:'.$estiloTextoSlide["width"].'%; right:'.$estiloTextoSlide["right"].'%">
											...
											<a href="'.$value["url"].'">';
												...
												echo'<button class="btn btn-default backColor text-uppercase">
