...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
	      ...
	      <li class="active">Reporte de electronica</li>
...
<hr>
<h3>
  REPORTE DE METAS | DEPARTAMENTO ELECTRONICA
</h3>
<br>
<div class="row">
  <div class="col-sm-6">
...
new Chart("myChart1", {
  ...
  options: {
    title: {
      display: true,
      text: "Grafica Departamento de Electronica"
    }
  }
});
var xValues2 = [
...
new Chart("myChart2", {
  ...
  data: {
    labels: xValues2,
    datasets: [{
        label: 'Departamento de Electronica',
       backgroundColor: [
      'rgba(255, 99, 132, 0.2)',
      'rgba(255, 159, 64, 0.2)',
      'rgba(255, 205, 86, 0.2)',
