...
if (is_array($garantia) && $sesionBackendGarantia && in_array($perfilGarantia, $perfilesInfoOrden, true)) {
    $destinoOrden = "index.php?ruta=infoOrden&idOrden=" . intval($garantia["id_orden"]);
