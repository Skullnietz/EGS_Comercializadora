...
<div class="content-wrapper egs-label-page">
  ...
  <section class="content">
    ...
    <div class="egs-label-intro">
      ...
      <div><h2>Generador de etiquetas</h2><p>Imprime a escala 100%, sin márgenes ni encabezados. Para garantía recomendamos vincular una orden y generar su QR.</p></div>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="box box-success egs-editor-box">
            <div class="box-header"><h3 class="box-title"><i class="fa-solid fa-address-card"></i> Datos de contacto</h3><span class="egs-size-pill">4 × 2.5 cm</span></div>
            <div class="box-body">
          ...
          <div class="box box-success egs-editor-box">
            <div class="box-header"><h3 class="box-title"><i class="fa-solid fa-shield-halved"></i> Datos de garantía</h3><span class="egs-size-pill">6.2 × 3.5 cm</span></div>
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 form-group"><label>Factura / remisión</label><input class="form-control egs-warranty-live" name="fac_rem" data-target="wFac" maxlength="80"></div>
                ...
                <div class="col-sm-7 form-group"><label>Equipo</label><input class="form-control" name="equipo" maxlength="220"></div>
                <div class="col-sm-5 form-group"><label>Núm. de serie</label><input class="form-control" name="numero_serie" maxlength="160"></div>
        ...
        <div class="col-lg-7">
          <div class="egs-preview-panel">
            ...
            <div class="egs-preview-section"><div class="egs-preview-title"><b>Etiqueta de contacto</b><span>4 × 2.5 cm</span></div><div class="egs-label-stage contact-stage">
              <div class="egs-print-label egs-contact-label" id="contactLabel">
                ...
                <div class="egs-contact-brand"><img src="vistas/img/plantilla/logo.png" alt="EGS"><b id="contactName"><?= egsH($config["nombre_comercial"]) ?></b><small id="contactTagline"><?= egsH($config["lema"]) ?></small></div>
                <div class="egs-green-rule"></div><div class="egs-contact-info"><b>DIRECCIÓN</b><p id="contactAddress"><?= egsH($config["direccion"]) ?></p><b>CONTACTO</b><p class="egs-phone-line" id="contactPhones"></p><p class="egs-site-line"><span>●</span> <span id="contactWebsite"><?= egsH($config["sitio_web"]) ?></span></p></div>
              </div>
            </div></div>

            <div class="egs-preview-section"><div class="egs-preview-title"><b>Etiqueta de garantía</b><span>6.2 × 3.5 cm</span></div><div class="egs-label-stage warranty-stage">
              <div class="egs-print-label egs-warranty-label" id="warrantyLabel">
                <i class="egs-corner egs-corner-tl"></i><i class="egs-corner egs-corner-br"></i>
                <div class="egs-warranty-contact"><img src="vistas/img/plantilla/logo.png" alt="EGS"><b class="wc-name"><?= egsH($config["nombre_comercial"]) ?></b><small class="wc-tagline"><?= egsH($config["lema"]) ?></small><strong>DIRECCIÓN</strong><p class="wc-address"><?= egsH($config["direccion"]) ?></p><strong>CONTACTO</strong><p class="wc-phones"></p><small class="wc-site"><?= egsH($config["sitio_web"]) ?></small></div>
                <div class="egs-warranty-rule"></div>
                <div class="egs-warranty-data">
                  <div class="egs-w-row"><b>ORDEN</b><span id="wOrder"></span><b class="fac-label">FAC. REM.</b><span id="wFac"></span></div>
                  ...
                  <div class="egs-validity-strip">CUALQUIER ALTERACIÓN DE ESTE SELLO PIERDE SU VALIDEZ DE GARANTÍA</div>
                  <div class="egs-next-service"><b>PRÓXIMO SERVICIO</b><span id="wService"></span></div>
                  <div id="warrantyQr" class="egs-label-qr"></div>
                </div>
              </div>
            </div></div>
          </div>
...
.egs-contact-label{width:4cm;height:2.5cm;display:grid;grid-template-columns:1.15cm .18cm 1fr;padding:1.6mm 1.5mm}.egs-contact-brand{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;min-width:0;padding-top:1mm}.egs-contact-brand img{width:10mm;height:3.5mm;object-fit:contain;margin-bottom:.5mm}.egs-contact-brand b{font-size:4.1pt;line-height:1.05}.egs-contact-brand small{font-size:3.2pt;line-height:1.08;margin-top:.5mm}.egs-green-rule{width:.6mm;background:#18763a;border-radius:1mm;margin:.8mm 1mm}.egs-contact-info{padding:.8mm 0 0 .2mm;min-width:0}.egs-contact-info>b{display:block;font-size:6pt;line-height:1;margin-bottom:.45mm}.egs-contact-info p{margin:0 0 .7mm;font-size:3.8pt;font-weight:600;line-height:1.18;overflow:hidden}.egs-contact-info .egs-phone-line{font-size:4.1pt;line-height:1.35}.egs-site-line{position:absolute;left:1.48cm;right:2mm;bottom:1.5mm;white-space:nowrap;text-overflow:ellipsis}.egs-site-line span:first-child{color:#16803b}
.egs-warranty-label{width:6.2cm;height:3.5cm;display:grid;grid-template-columns:2.05cm .16cm 1fr;padding:1.5mm}.egs-warranty-contact{padding:1mm .7mm .4mm;display:flex;flex-direction:column;align-items:flex-start;overflow:hidden}.egs-warranty-contact img{width:15mm;height:4.2mm;object-fit:contain;align-self:center;margin-bottom:.3mm}.egs-warranty-contact .wc-name{align-self:center;font-size:5pt;line-height:1}.egs-warranty-contact .wc-tagline{align-self:center;font-size:3pt;margin-bottom:.8mm}.egs-warranty-contact strong{font-size:5.6pt;line-height:1;margin:.45mm 0}.egs-warranty-contact p{font-size:3.5pt;font-weight:600;line-height:1.18;margin:0}.egs-warranty-contact .wc-phones{font-size:3.7pt;line-height:1.3}.egs-warranty-contact .wc-site{font-size:3pt;font-weight:700;margin-top:.6mm;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.egs-warranty-rule{width:.6mm;background:#18763a;border-radius:1mm;margin:0 .6mm}.egs-warranty-data{position:relative;padding:.8mm .4mm 0 1mm;min-width:0}.egs-w-row{display:grid;grid-template-columns:15mm 1fr;align-items:end;height:4.2mm;font-size:5pt}.egs-w-row b{font-size:5.2pt;white-space:nowrap}.egs-w-row span{display:block;border-bottom:.25mm solid #222;height:3.2mm;line-height:3mm;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding-left:.5mm}.egs-w-row:first-child{grid-template-columns:7mm 1fr 10mm 1fr;gap:.5mm}.egs-w-row:first-child .fac-label{text-align:right}.egs-date-row{grid-template-columns:8mm 1fr 7mm 1fr;gap:.5mm}.egs-date-row b:nth-of-type(2){text-align:right}.egs-validity-strip{height:3.5mm;background:#18763a;color:#fff;font-size:3.4pt;font-weight:700;line-height:3.5mm;padding:0 .8mm;white-space:nowrap;overflow:hidden;margin-top:.6mm;margin-right:11mm}.egs-next-service{position:absolute;left:1mm;right:12mm;bottom:1.7mm;display:grid;grid-template-columns:18mm 1fr;align-items:end;font-size:5pt}.egs-next-service span{border-bottom:.25mm solid #222;height:3mm;text-align:center}.egs-label-qr{position:absolute;right:.6mm;bottom:.4mm;width:10mm;height:10mm;background:#fff;padding:.35mm;box-sizing:border-box}.egs-label-qr canvas,.egs-label-qr img{width:100%!important;height:100%!important;display:block!important}.egs-label-qr:empty{display:none}
...
(function(){
  ...
  function syncContact(){
    ...
    document.querySelectorAll('.wc-site').forEach(function(e){e.textContent=val('sitio_web')});
  }
  ...
  function renderQr(token){
    var box=document.getElementById('warrantyQr'); box.innerHTML='';
    var url=token ? validationBase+encodeURIComponent(token) : '';
    if(url && typeof QRCode!=='undefined') new QRCode(box,{text:url,width:128,height:128,correctLevel:QRCode.CorrectLevel.L});
  ...
  window.egsPrintLabel=function(type){
    ...
    if(type==='warranty' && document.querySelector('[name="modo_etiqueta"]:checked').value==='orden' && !document.querySelector('#warrantyQr canvas')){
      Swal.fire({icon:'info',title:'Primero genera el QR',text:'Guarda la garantía vinculada antes de imprimirla.'}); return;
    }
    var clone=source.cloneNode(true), canvas=source.querySelector('#warrantyQr canvas'), cloneQr=clone.querySelector('#warrantyQr');
    if(canvas&&cloneQr) cloneQr.innerHTML='<img src="'+canvas.toDataURL('image/png')+'" alt="QR">';
    ...
    win.document.close(); win.focus(); setTimeout(function(){win.print();},450);
  };
})();
</script>
