          ...
          <div class="egs-preview-panel">
            ...
            <div class="egs-preview-section"><div class="egs-preview-title"><b>Etiqueta de garantía</b><span>6.2 × 3.5 cm</span></div><div class="egs-label-stage warranty-stage">
              <div class="egs-print-label egs-warranty-label" id="warrantyLabel">
                <i class="egs-corner egs-corner-tl"></i><i class="egs-corner egs-corner-br"></i>
                <div class="egs-warranty-contact"><img src="vistas/img/plantilla/logo-etiquetas.svg" alt="EGS"><b class="wc-name"><?= egsH($config["nombre_comercial"]) ?></b><small class="wc-tagline"><?= egsH($config["lema"]) ?></small><strong>DIRECCIÓN</strong><p class="wc-address"><?= egsH($config["direccion"]) ?></p><strong>CONTACTO</strong><p class="wc-phones"></p><small class="wc-site"><?= egsH(egsSitioVisible($config["sitio_web"])) ?></small></div>
