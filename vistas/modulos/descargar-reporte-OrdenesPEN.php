...
// $objeto -> ctrReporteOrdenesSuper();
$valorEmpresa = $_GET["empresa"];
// $objeto = controladorOrdenes::ctrReporteOrdenesSuper($valorEmpresa);

require_once "reporte_helper.php";
ReporteHelper::generarReporteExcel("Supervisión (SUP)", $valorEmpresa, "OrdenesSUP");
