 	...
 	<!-- box-body -->
  	<div class="box-body">
	    ...
	    <div class="row">
          ...
          for($i = 0; $i < 5; $i++){
              ...
              echo '<li>
              <i class="fa fa-circle-o text-'.$colores[$i].'"></i> '.$productos[$i]["titulo"].'</li>';
          }
      ...
      <?php
        ...
        for($i = 0; $i < 5; $i++){
            ...
            echo '<li>  
            <img src="'.$productos[$i]["portada"].'" class="img-thumbnail" width="40px" style="margin-right:0px"><a href="#">'.$productos[$i]["titulo"].'
