...
══════════════════════════════════════════ */
  ...
  .user-menu.open>a.egs-trigger .egs-caret {
...
══════════════════════════════════════════ */
  ...
  .egs-rank-pos1 {
    color: #fbbf24;
    animation: egs-shine-gold 2.5s ease-in-out infinite;
  }

  .egs-rank-pos2 {
    color: #a8b4c4;
    animation: egs-shine-silver 2.5s ease-in-out infinite;
  }

  .egs-rank-pos3 {
    color: #d97706;
    animation: egs-shine-bronze 2.5s ease-in-out infinite;
  }
  ...
  @keyframes egs-shine-silver {
    ...
    50% {
      color: #e2e8f0;
      filter: drop-shadow(0 0 8px rgba(148, 163, 184, .6));
    }
  }
  ...
  @keyframes egs-shine-bronze {
    ...
    50% {
      color: #fbbf24;
      filter: drop-shadow(0 0 8px rgba(217, 119, 6, .6));
    }
  }
  ...
  .egs-ach-gold .egs-ach-pos {
    background: linear-gradient(135deg, #f59e0b, #eab308);
  }

  .egs-ach-silver .egs-ach-pos {
    background: linear-gradient(135deg, #94a3b8, #64748b);
  }

  .egs-ach-bronze .egs-ach-pos {
    background: linear-gradient(135deg, #d97706, #b45309);
  }
  ...
  .egs-ach-gold .egs-ach-icon {
    color: #f59e0b;
  }

  .egs-ach-silver .egs-ach-icon {
    color: #94a3b8;
  }

  .egs-ach-bronze .egs-ach-icon {
    color: #d97706;
  }
  ...
  .egs-ach-gold .egs-ach-text {
    color: #92400e;
  }

  .egs-ach-silver .egs-ach-text {
    color: #475569;
  }

  .egs-ach-bronze .egs-ach-text {
    color: #7c2d12;
  }
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="egs-navbar-search" style="position:relative">
      <div class="egs-search-box" id="egsSearchBox">
        ...
        <input type="text" class="egs-search-input" id="egsSearchInput"
          placeholder="Buscar órdenes, clientes, productos..." autocomplete="off">
