<div id="posCajeroRoot" class="pos-page">
  ...
  <style>
    ...
    #modalPosCatalogo .dataTables_wrapper .dataTables_filter input {
      border-radius: 10px !important; border: 1px solid var(--crm-border) !important;
      min-width: 220px; height: 36px; padding: 6px 12px;
    }
    #modalPosCatalogo .dataTables_wrapper > .row {
      margin-left: 0; margin-right: 0;
    }
    #modalPosCatalogo .dataTables_wrapper > .row:first-child {
      display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between;
      gap: 10px; margin-bottom: 10px;
    }
    #modalPosCatalogo .dataTables_wrapper > .row:first-child .col-sm-6,
    #modalPosCatalogo .dataTables_wrapper > .row:first-child .col-sm-12 {
      width: auto; float: none; flex: 1 1 auto; padding: 0;
    }
    #modalPosCatalogo .dataTables_wrapper > .row:last-child,
    #modalPosCatalogo .dataTables_wrapper .pos-cat-dt-bottom {
      display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between;
      gap: 10px; margin-top: 12px; padding-top: 10px; border-top: 1px solid #f1f5f9;
    }
    #modalPosCatalogo .dataTables_wrapper > .row:last-child .col-sm-5,
    #modalPosCatalogo .dataTables_wrapper > .row:last-child .col-sm-7,
    #modalPosCatalogo .dataTables_wrapper .pos-cat-dt-bottom .dataTables_info,
    #modalPosCatalogo .dataTables_wrapper .pos-cat-dt-bottom .dataTables_paginate {
      width: auto !important; float: none !important; padding: 0 !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_info {
      color: var(--crm-muted); font-size: 12px; font-weight: 600; padding: 0; white-space: normal;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate {
      margin: 0; text-align: right; white-space: normal; flex: 1 1 auto; min-width: 0;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination {
      display: flex; flex-wrap: wrap; justify-content: flex-end; align-items: center;
      gap: 4px; margin: 0; float: none !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li {
      display: inline-block; float: none !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate .paginate_button {
      padding: 0 !important; margin: 0 !important; border: 0 !important;
      background: transparent !important; box-shadow: none !important; float: none !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button > a,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button > span {
    ...
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button > a:hover,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button > a:focus {
      background: #eef2ff !important; border-color: #a5b4fc !important; color: #3730a3 !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.active > a,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.active > a:hover,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.active > a:focus {
      background: var(--crm-accent) !important; border-color: var(--crm-accent) !important; color: #fff !important;
    }
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.disabled > a,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.disabled > a:hover,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.disabled > a:focus,
    #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination > li.paginate_button.disabled > span {
      background: #f8fafc !important; border-color: #e2e8f0 !important; color: #94a3b8 !important;
      cursor: default;
    }
    @media (max-width: 767px) {
      #modalPosCatalogo .dataTables_wrapper > .row:first-child .col-sm-6 { width: 100% !important; }
      #modalPosCatalogo .dataTables_wrapper .dataTables_filter input { width: 100%; min-width: 0; }
      #modalPosCatalogo .dataTables_wrapper > .row:last-child { flex-direction: column; align-items: stretch; }
      #modalPosCatalogo .dataTables_wrapper .dataTables_paginate { text-align: center; }
      #modalPosCatalogo .dataTables_wrapper .dataTables_paginate ul.pagination { justify-content: center; }
    }
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table id="tablaProductosPos" class="table table-bordered table-striped tablaProductosPos" width="100%">
          <thead>
            <tr>
              <th>#</th>
              <th>Imagen</th>
