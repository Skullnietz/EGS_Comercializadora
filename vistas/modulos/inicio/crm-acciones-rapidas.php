...
} catch (Exception $e) { $_ar_metas = array(); }
...
<div class="crm-card" style="margin-bottom:20px">
  ...
  <div class="crm-card-body" style="padding:16px 18px">
    ...
    <!-- Metas progress ring -->
    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px;display:flex;align-items:center;gap:16px">
      <?php if ($_ar_metasTotal > 0): ?>
        ...
        <div style="flex:1">
          <div style="font-size:13px;font-weight:700;color:#0f172a;margin-bottom:2px">Mis Metas</div>
          <div style="font-size:12px;color:#94a3b8;margin-bottom:6px">
            <?php echo $_ar_metasCompletas; ?> de <?php echo $_ar_metasTotal; ?> completadas
          </div>
          <a href="index.php?ruta=metas" style="font-size:11px;color:#6366f1;font-weight:600;text-decoration:none">
      ...
      <?php else: ?>
        <div style="text-align:center;width:100%;padding:4px 0">
          ...
          <div style="font-size:12px;color:#94a3b8;margin-bottom:4px">Sin metas asignadas</div>
          <a href="index.php?ruta=metas" style="font-size:11px;color:#6366f1;font-weight:600;text-decoration:none">
