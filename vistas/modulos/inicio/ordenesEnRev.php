...
<div class="box box-danger">
	...
	<!-- box-header -->
  	<div class="box-header with-border">
	    ...
	    <h3 class="box-title">Ordenes Revision</h3>
	    ...
	    <div class="box-tools">
	    	...
	    	<?php
             ...
             echo '<a href="vistas/modulos/descargar-reporte-OrdenesPorEstado.php?reporte=ordenesOk&empresa='.$_SESSION["empresa"].'&estado='.$estadoreporte.'&tecnico='.$tecnicoEnSession["id"].'">
