...
.soc-google-icon svg { width: 32px; height: 32px; }
...
.soc-google-btn svg { width: 20px; height: 20px; }
      ...
      <div class=”soc-card”>
        ...
        <div class=”soc-google-section”>
          ...
          <a href=”https://www.google.com/maps/place/EGS+EQUIPO+DE+C%C3%93MPUTO+Y+SOFTWARE/@19.2933702,-99.6549282,17z/” target=”_blank” rel=”noopener” class=”soc-google-btn”>
            <svg viewBox=”0 0 24 24” xmlns=”http://www.w3.org/2000/svg”><path d=”M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z” fill=”#fff”/><path d=”M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z” fill=”#fff”/><path d=”M5.84 14.09a6.87 6.87 0 0 1 0-4.17V7.07H2.18a11.01 11.01 0 0 0 0 9.86l3.66-2.84z” fill=”#fff”/><path d=”M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z” fill=”#fff”/></svg>
            Dejar reseña en Google
          </a>
          <div class=”soc-google-hint”>Se abrirá Google Maps en una nueva pestaña</div>
        </div>
      </div>
