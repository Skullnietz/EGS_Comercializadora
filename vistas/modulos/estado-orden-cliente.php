...
@media (max-width: 576px) {
    ...
    .soc-google-cta { flex-direction: column; text-align: center; }
...
.soc-google-cta-icon svg { width: 24px; height: 24px; }
.soc-google-cta-text { flex: 1; font-size: 12px; color: #334155; line-height: 1.5; }
.soc-google-cta-text strong { color: #0f172a; }
.soc-google-btn {
...
.soc-google-btn:hover { background: #f8fafc; border-color: #94a3b8; box-shadow: 0 4px 12px rgba(0,0,0,.1); }
.soc-google-btn svg { width: 16px; height: 16px; }
</style>
