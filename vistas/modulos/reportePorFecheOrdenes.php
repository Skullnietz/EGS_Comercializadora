...
/* ── Helper: badge de estado (reutiliza lógica del sistema) ── */
...
/* ── Helper para generar links de descarga ── */
...
<style>
/* ── Estilos del reporte de órdenes ── */
:root {
  --rpt-bg: #f8fafc;
  --rpt-card: #ffffff;
  --rpt-border: #e2e8f0;
...
/* Badge overrides for inline use */
...
<div class="content-wrapper" style="background: var(--rpt-bg);">
  ...
  <section class="content" style="padding-top: 20px;">
    ...
    <div class="rpt-kpi-row">
      <div class="rpt-kpi">
        ...
        <div class="rpt-kpi-body">
          <h4><?= number_format($totalOrdenes) ?></h4>
      ...
      <div class="rpt-kpi">
        ...
        <div class="rpt-kpi-body">
          <h4>$<?= number_format($sumaTotal, 2) ?></h4>
      ...
      <div class="rpt-kpi">
        ...
        <div class="rpt-kpi-body">
          <h4>$<?= number_format($sumaInversion, 2) ?></h4>
      ...
      <div class="rpt-kpi">
        ...
        <div class="rpt-kpi-body">
          <h4 class="<?= $utilidad >= 0 ? '' : 'rpt-money negative' ?>">$<?= number_format($utilidad, 2) ?></h4>
    ...
    <div class="rpt-table-wrap">
      <table class="table dt-responsive tablaVentasRCorte" width="100%">
        <thead>
          <tr>
            <th>#</th>
            <th>Orden</th>
            ...
            <th>Estado</th>
            <th>Total</th>
            <?php if(in_array($perfil, ['administrador','Super-Administrador'])): ?>
              <th>Inversión</th>
              <th>Utilidad</th>
            <?php endif; ?>
            <th>Ingreso</th>
