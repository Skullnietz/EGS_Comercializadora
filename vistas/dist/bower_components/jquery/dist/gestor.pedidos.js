...
$.ajax({
  ...
  url:"ajax/tablapedidos.ajax.php?perfil="+$("#tipoDePerfil").val(),
...
$(".tablaPedidos").DataTable({
  "ajax": "ajax/tablapedidos.ajax.php?perfil="+$("#tipoDePerfil").val(),
	 "deferRender": true,
	 "retrieve": true,
	 "processing": true,
	 "language": {
...
function validarselect(){
  ...
  var seleccionarEmpresa = document.getElementById('empresaPedioDinamico');

  if (seleccionarEmpresa.value=="seleccionador" || seleccionarEmpresa ==""){

    swal({
        type: "success",
        title: "El campo empresa no puede ir vacío",
        showConfirmButton: true,
        confirmButtonText: "Cerrar"
        }).then(function(result){
        if (result.value) {
