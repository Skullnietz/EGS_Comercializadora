		...
		if(isset($_POST["tipoBanner"])){
			...
			if(isset($_FILES["fotoBanner"]["tmp_name"]) && !empty($_FILES["fotoBanner"]["tmp_name"])){
				...
				if($_FILES["fotoBanner"]["type"] == "image/png"){
					...
					$rutaBanner = "vistas/img/".$_FILES["fotoBanner"]["name"].".png";
				...
				if ($_FILES["fotoBanner"]["type"] == "image/gif") {
					
					$rutaBanner = "vistas/img/".$_FILES["fotoBanner"]["name"];
			...
			if($respuesta == "ok"){
				...
				swal({
					  ...
					  confirmButtonText: "Cerrar"
						...
						window.location = "index.php?ruta=banner";
