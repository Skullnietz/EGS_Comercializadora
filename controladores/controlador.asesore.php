...
class Controladorasesores{
	...
	/*=============================================
  	MOSTRAR ASESORES CON PARAMETRO
  	=============================================*/	
	...
	/*=============================================
  	MOSTRAR ASESORES PARA EMPRESAS
  	=============================================*/	
	static public function ctrMostrarAsesoresEmpresas($item, $valor){
		
		$tabla = "asesores";

		$respuesta = ModeloAsesores::mdlMostrarAsesoresEmpresas($tabla, $item, $valor);
				...
				if($respuesta == "ok"){
					...
					swal({
						...
						if(result.value){
							...
							window.location = "index.php?ruta=asesores";
...
static public function ctrEditarAsesor(){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombreAsesor"]) &&
			   preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["editarEmailAsesor"])){
				...
				$datos = array("id" => $_POST["idAsesor"],
							   ...
							   "porcentajeComision" => $_POST["editarPorcentajeComision"],
							   "estado" => $_POST["estado"]
							   );
	...
	/*=============================================
  	...
  	=============================================*/	
	function ctrlMostrarTodosLosEmpleado(){
		
		$tablaUno = "asesores";
		$tablaDos = "tecnicos";

		$respuesta = ModeloAsesores::mdlMostrarTodosLosEmpleado($tablaUno,$tablaDos);
