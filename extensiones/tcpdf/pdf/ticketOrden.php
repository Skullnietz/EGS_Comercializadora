  ...
  function TraerImpresionTicketOrden(){
     ...
     //TRAER ASESOR
      ...
      if (!empty($tokenParaQR)) {
          ...
          $qrUrlPortal = 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&margin=10&data=' . urlencode($urlPortal);

          echo '<hr style="margin:6px 0 3px">
                <div style="border:2px solid #000;padding:8px;text-align:center">
                  <div style="font-size:14px;font-weight:900;margin-bottom:4px">*** TU PORTAL EGS ***</div>
                  <div style="font-size:12px;line-height:1.3;margin-bottom:8px">Escanea este codigo para ver tus equipos, monedero, historial, solicitar ayuda y aceptar el aviso de privacidad.</div>
                  <img src="'.$qrUrlPortal.'" alt="QR Portal Cliente" style="width:220px;height:220px;display:block;margin:0 auto">
                </div>';
      }
      ...
      // =============================================
      // AVISO DE PRIVACIDAD — solo en la PRIMERA IMPRESIÓN del cliente (estado REV).
      // Después el cliente puede aceptar y firmar digitalmente desde el portal
      // (tab "Privacidad"). Se imprime en una página separada para firmarse a mano
      // en el momento de dejar el equipo, como respaldo en papel.
      // =============================================
      if (stripos($estadoOrden, 'REV') !== false) {
          ...
          <div class="zona_impresion" style="font-family:Arial,Helvetica,sans-serif; page-break-before: always; margin-top:10px;">
            ...
            <div style="font-size:15px; text-align:justify; line-height:1.4;">
              ...
              <p style="margin:8px 0;">Tu privacidad es importante. Puedes revocar este permiso por escrito en cualquier momento o desde el portal digital escaneando el QR del ticket.</p>
