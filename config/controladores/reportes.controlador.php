...
class ControladorReportes{
	...
	public function ctrDescargarReporteR(){
		...
		if(isset($_GET["reporte"])){
			...
			if($_GET["reporte"] == "compras"){	
				...
				foreach ($reporte as $key => $value) {
            		...
            		$traerEmpresa = ControladorEmpresas::ctrMostrarEmpresasParaEditar($item, $valor);
				  ...
				  /*=============================================
					...
					echo utf8_decode("</td>
									 ...
									 <td style='border:1px solid #eee;'>".$traerEmpresa."</td>
