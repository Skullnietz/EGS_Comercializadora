	 	...
	 	for($i = 0; $i < count($productos); $i++){
  		...
  		$item = "id";
			...
			if($cabeceras["portada"] != ""){
  				...
  				$imagenPortada = "<img loading='lazy' src='".$cabeceras["portada"]."' class='img-thumbnail imgPortadaProductos' width='100px'>";

  			}else{

  				$imagenPortada = "<img loading='lazy' src='vistas/img/cabeceras/default/default.jpg' class='img-thumbnail imgPortadaProductos' width='100px'>";
  			}
			...
			/*=============================================
  			...
  			$imagenPrincipal = "<img loading='lazy' src='".$productos[$i]["portada"]."' class='img-thumbnail imgTablaPrincipal' width='100px'>";
			...
			TRAER MULTIMEDIA
  			...
  			if($productos[$i]["multimedia"] != null){
  				...
  				if($multimedia[0]["foto"] != ""){
  					...
  					$vistaMultimedia = "<img loading='lazy' src='".$multimedia[0]["foto"]."' class='img-thumbnail imgTablaMultimedia' width='100px'>";

  				}else{

  					$vistaMultimedia = "<img loading='lazy' src='http://i3.ytimg.com/vi/".$productos[$i]["multimedia"]."/hqdefault.jpg' class='img-thumbnail imgTablaMultimedia' width='100px'>";
  				...
  				$vistaMultimedia = "<img loading='lazy' src='vistas/img/multimedia/default/default.jpg' class='img-thumbnail imgTablaMultimedia' width='100px'>";
  			...
  			if($productos[$i]["tipo"] == "fisico"){
				...
				$vistaDetalles = "Reparacion: ".$detalles["Reparacion"];
			...
			if($productos[$i]["oferta"] != 0){
  			...
  			if($productos[$i]["imgOferta"] != ""){
	  			...
	  			$imgOferta = "<img loading='lazy' src='".$productos[$i]["imgOferta"]."' class='img-thumbnail imgTablaProductos' width='100px'>";

	  		}else{

	  			$imgOferta = "<img loading='lazy' src='vistas/img/ofertas/default/default.jpg' class='img-thumbnail imgTablaProductos' width='100px'>";
