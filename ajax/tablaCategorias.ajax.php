  	...
  	$datosJson ='{
		...
		for($i = 0; $i < count($categorias); $i++){
			...
			if($cabeceras["portada"] != ""){
				 ...
				 $imgPortada = "<img loading='lazy' class='img-thumbnail imgPortadaCategorias' src='".$cabeceras["portada"]."' width='100px'>";

			}else{

				$imgPortada = "<img loading='lazy' class='img-thumbnail imgPortadaCategorias' src='vistas/img/cabeceras/default/default.jpg' width='100px'>";
			}
			...
			if($categorias[$i]["imgOferta"] != ""){
				 ...
				 $imgOfertas = "<img loading='lazy' class='img-thumbnail imgOfertaCategorias' src='".$categorias[$i]["imgOferta"]."' width='100px'>";

			}else{

				$imgOfertas = "<img loading='lazy' class='img-thumbnail imgOfertaCategorias' src='vistas/img/ofertas/default/default.jpg' width='100px'>";
