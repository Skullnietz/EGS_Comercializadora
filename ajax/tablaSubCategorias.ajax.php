		...
		for($i = 0; $i < count($subcategorias); $i++){
			...
			$cabeceras = ControladorCabeceras::ctrMostrarCabeceras($item2, $valor2);
  			...
  			if($cabeceras["portada"] != ""){
  				...
  				$imagenPortada = "<img loading='lazy' src='".$cabeceras["portada"]."' class='img-thumbnail imgPortadaSubCategorias' width='100px'>";

  			}else{

  				$imagenPortada = "<img loading='lazy' src='vistas/img/default/default.png' class='img-thumbnail imgPortadaSubCategorias' width='100px'>";
  			}
			...
			if($subcategorias[$i]["oferta"] != 0){
  			...
  			if($subcategorias[$i]["imgOferta"] != ""){
	  			...
	  			$imgOferta = "<img loading='lazy' src='".$subcategorias[$i]["imgOferta"]."' class='img-thumbnail imgTablaSubCategorias' width='100px'>";

	  		}else{

	  			$imgOferta = "<img loading='lazy' src='vistas/img/ofertas/default/default.jpg' class='img-thumbnail imgTablaSubCategorias' width='100px'>";
