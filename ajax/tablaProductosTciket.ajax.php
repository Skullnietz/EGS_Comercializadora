...
class TablaProductosDinamicosTicket{

  /*=============================================
  MOSTRAR LA TABLA DE PRODUCTOS
  =============================================*/ 

  public function mostrarTablaProductosDinamicosTicket(){	
  	...
  	$datosJson = '
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-primary agregarProductoTicket recuperarBoton' idProducto='".$productos[$i]["id"]."'>Agregar</button></div>"; 
...
=============================================*/ 
$activarProductos = new TablaProductosDinamicosTicket();
$activarProductos -> mostrarTablaProductosDinamicosTicket();