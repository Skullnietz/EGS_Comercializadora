...
class AjaxComercio{
	...
	public $tasaMininaNa;
	public $tasaMininaInter;
	public $seleccionarPais;
	public $modoPaypal;
	public $clienteidPaypal;
	public $llaveSecretPaypal;
	public $modoPayu;
	public $LlavePublicaMercadoPago;
	public $TokenDeAcceso;
	...
	public function ajaxCambiarInformacion(){
		...
		$datos = array("impuesto"=>$this->impuesto,
						...
						"tasaMininaNa"=>$this->tasaMininaNa,
						"tasaMininaInter"=>$this->tasaMininaInter,
						"seleccionarPais"=>$this->seleccionarPais,
						"modoPaypal"=>$this->modoPaypal,
						"clienteidPaypal"=>$this->clienteidPaypal,
						"llaveSecretPaypal"=>$this->llaveSecretPaypal,
						"modoPayu"=>$this->modoPayu,
						"LlavePublicaMercadoPago"=>$this->LlavePublicaMercadoPago,
						"TokenDeAcceso"=>$this->TokenDeAcceso);
...
if(isset($_POST["impuesto"])){
	...
	$informacion -> tasaMininaNa = $_POST["tasaMininaNa"];
	$informacion -> tasaMininaInter = $_POST["tasaMininaInter"];
	...
	$informacion -> llaveSecretPaypal = $_POST["llaveSecretPaypal"];
	$informacion -> modoPayu = $_POST["modoPayu"];
	$informacion -> LlavePublicaMercadoPago = $_POST["LlavePublicaMercadoPago"];
	$informacion -> TokenDeAcceso = $_POST["TokenDeAcceso"];
