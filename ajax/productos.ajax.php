...
class AjaxProductos{
	...
	/*=============================================
 	...
 	=============================================*/	
 	 ...
 	 public function ajaxBuscarProductoPorCodigo(){

 	 	$itemCodigo = "codigo";
		$valorCodigo = $this->codigoProducto;

		$respuesta = ControladorProductos::ctrMostrarProductos($itemCodigo, $valorCodigo);
	...
	public $SubircodigoProducto;

	public $codigoEditado;

	public $inversionEditada;

	public $EntradInversion;
	...
	public function  ajaxCrearProducto(){ 
		...
		$datos = array(
			...
			"SubircodigoProducto"=>$this->SubircodigoProducto,

			"EntradInversion"=>$this->EntradInversion,

			"medida"=>$this->medida,

			"cantidadTipo"=>$this->cantidadTipo,
	...
	public $traerProductosDispositivo;

	public $nombreProdcuto;
	...
	public function ajaxTraerProducto(){
		...
		if ($this->traerProductosDispositivo=="ok") {
		...
		}else if ($this->nombreProdcuto !=""){

			

			$item = "titulo";

			$valor = $this->nombreProdcuto;
	...
	public function  ajaxEditarProducto(){
		...
		$datos = array(
			...
			"codigoEditado"=>$this->codigoEditado,

			"inversionEditada"=>$this->inversionEditada,
...
if(isset($_POST["codigoProducto"])){
	...
	$productoporcodigo = new AjaxProductos();

	$productoporcodigo -> codigoProducto = $_POST["codigoProducto"];

	$productoporcodigo -> ajaxBuscarProductoPorCodigo();
...
if(isset($_POST["tituloProducto"])){
	...
	$producto -> disponibilidad = $_POST["disponibilidad"];

	$producto -> Proveedor = $_POST["Proveedor"];

	$producto -> multimedia = $_POST["multimedia"];

	$producto -> SubircodigoProducto = $_POST["SubircodigoProducto"];

	$producto -> EntradInversion = $_POST["EntradInversion"];

	$producto -> medida = $_POST["medida"];

	$producto -> cantidadTipo = $_POST["cantidadTipo"];
	...
	$producto -> id_almacen = $_POST["id_almacen"];

	$producto -> id_empresa = $_POST["id_empresa"];
...
TRAER PRODUCTO PARA DISPOSITIVOS MOVILES

=============================================*/

if(isset($_POST["traerProductosDispositivo"])){



	$traerProductosDispositivoMoviles = new AjaxProductos();

	$traerProductosDispositivoMoviles -> traerProductosDispositivo = $_POST["traerProductosDispositivo"];

	$traerProductosDispositivoMoviles -> ajaxTraerProducto();
...
if(isset($_POST["nombreProdcuto"])){

	$traerProductosDispositivoMoviles = new AjaxProductos();

	$traerProductosDispositivoMoviles -> nombreProdcuto = $_POST["nombreProdcuto"];
...
if(isset($_POST["id"])){
	...
	$editarProducto -> empresa = $_POST["empresa"];
	...
	$editarProducto -> disponibilidad = $_POST["disponibilidad"];

	$editarProducto -> Proveedor = $_POST["Proveedor"];

	$editarProducto -> multimedia = $_POST["multimedia"];

	$editarProducto -> codigoEditado= $_POST["codigoEditado"];

	$editarProducto-> inversionEditada = $_POST["inversionEditada"];

	$editarProducto-> medida = $_POST["medida"];
