	  	...
	  	$datosJson = '{
	 		...
	 		"data": [ ';
	 			...
	 			for ($i=0; $i < count($productos); $i++) { 
	 				...
	 				$acciones = "<button class='btn btn-warning btnEditarStockAlerta' data-toggle='modal' data-target='#ModalAgregarStockAgotandose' idProducto=".$productos[$i]["id"]."><i class='fa fa-pencil'><i></button>";
