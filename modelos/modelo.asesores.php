...
class ModeloAsesores{
	...
	public function mdlEditarAsesor($tabla,$datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, correo = :correo, numerodeCelular = :numerodeCelular, numeroTelefono = :numeroTelefono, porcentajeComision = :porcentajeComision, estado = :estado WHERE id = :id");
