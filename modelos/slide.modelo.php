...
class ModeloSlide{	
	...
	/*=============================================
	ACTUALIZAR SLIDE CON GIF
	=============================================*/

	static public function MdlModificarSlideConGif($tabla, $rutaGif, $datos){

		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, tipoSlide = :tipoSlide, estiloImgProducto = :estiloImgProducto, estiloTextoSlide = :estiloTextoSlide, imgFondo = :imgFondo, titulo1 = :titulo1, titulo2 = :titulo2, titulo3 = :titulo3, boton = :boton, url = :url WHERE id = :id");
